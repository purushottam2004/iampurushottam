...
| File | What it covers |
| --- | --- |
| [`tests/web-smoke.spec.ts`](./tests/web-smoke.spec.ts) | Public home loads; intro photo and welcome copy render; published writing and a seeded project show; drafts stay hidden; About, a post, and a project page render; WhatsApp and mail contact buttons point at seeded site_settings. |
