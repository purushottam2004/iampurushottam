...
| [`tests/web-login.spec.ts`](./tests/web-login.spec.ts) | Header login modal; wrong password stays open; `test@example.com` has no edit chrome; owner sees New / drafts. |
