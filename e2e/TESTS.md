...
| File | What it covers |
| --- | --- |
| [`tests/web-smoke.spec.ts`](./tests/web-smoke.spec.ts) | Public home loads; intro photo and welcome copy render; published posts show; drafts stay hidden; About and a post page render; WhatsApp and mail contact buttons point at seeded site_settings. |
