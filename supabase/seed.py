...
Examples:
  python_seeds/_001_seed_users.py          # committed
...
def discover_seed_scripts() -> List[Tuple[str, str]]:
    ...
    seed_files = sorted(p for p in python_seeds_dir.iterdir() if is_seed_script(p))
    ...
    try:
        ...
        if not main_func:
            ...
            print_info(
                ...
                "(e.g. seed_users for _001_seed_users), or main / seed"
            )
            return False
...
def main():
    print_header("Database Python Seed Scripts")
